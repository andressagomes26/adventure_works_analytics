with 
    ...
    , transformed_data as (
        select
            {{ dbt_utils.generate_surrogate_key(['stg_sales_order_header.sales_order_id']) }} as agg_sales_region_person_sk
            ...
            , stg_sales_order_header.territory_id
...
--   , stg_sap_adw__countryregion.country_region_name
